...
                sql = "CREATE TABLE " + username + " " + type + "(NAME STRING PRIMARY KEY NOT NULL" + 
                "CLASSNAME STRING NOT NULL," + "START_TIME STRING NOT NULL," + "END_TIME STRING NOT NULL," + 
                "LOCATION STRING NOT NULL);";
            }
            if(type.equals("EVENT")){
                sql = "CREATE TABLE " + username + " " + type + "(NAME STRING PRIMARY KEY NOT NULL" + 
                "DAY STRING NOT NULL," + "DAYS_LEFT STRING NOT NULL," + "PRIORITY STRING NOT NULL," + 
